...
def main():
    ...
    hparamsets = [hparams1, hparams2, hparams3, hparams5, hparams6, hparams7,] #[hparams, hparams1, hparams2] #build_hparamsets(hparams)
    ...
    opts = {
        ...
        'time': 38.5, # 1.5M train set, 50 epochs, 1 multistart/job?, time in hours

...
srun python3 gpu_test.py --data_list fom_pol_big/train/ --ensemble bigE --save bigEpol2
#srun python3 gpu_test.py --input_channels 2 --save 733unpol_test --data_list fom_unpol/test/ --model_list 733_mserrall1 733_mserrall1_2
